...
1. [Библиотека datetime](#119-библиотека-datetime)
1. [Перевод строки в дату](#1110-перевод-строки-в-дату)
1. [Перевод даты в строку](#1111-перевод-даты-в-строку)
1. [Задания на преобразования дат](#1112-задания-на-преобразования-дат)
1. [Синтаксис и принцип работы timedelta](#1113-синтаксис-и-принцип-работы-timedelta)
1. [Перебор дат в цикле](#1114-перебор-дат-в-цикле)
