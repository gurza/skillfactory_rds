...
**Содержание**
1. Основные объекты Pandas: Series
1. Основные объекты Pandas: DataFrame
1. Основные объекты Pandas: read_csv
1. Получение информации о датафрейме: head и tail
1. Получение информации о датафрейме: info
1. Получение информации о датафрейме: describe
1. Индексация и извлечение данных: статистические методы
1. Извлекаем данные по условиям
