...
1. [О чём этот модуль](#81-о-чём-этот-модуль)
1. [Букмекерская контора](#82-букмекерская-контора)
1. [Введение в блок](#83-введение-в-блок)
1. [Разбираемся с log.csv](#84-разбираемся-с-logcsv)
1. [Колонки](#85-колонки)
1. [Формат данных](#86-формат-данных)
1. [Очистка данных](#87-очистка-данных)
1. [Простая фильтрация](#88-простая-фильтрация)
1. [Функция query](#89-функция-query)
1. [Функции str.match и str.contains](#810-функции-strmatch-и-strcontains)
1. [Преобразование данных](#811-преобразование-данных)
1. [Финальное задание](#811-преобразование-данных)
